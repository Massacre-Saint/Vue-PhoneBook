...
<template>
    ...
    <div class="panel-block">
      <form @submit.prevent="handelSubmit" class="is-flex is-flex-direction-column is-flex-grow-1 mt-3">
        <div class="field">
        ...
        type="submit" class="button is-link is-info">Add Contact</button>
      </form>
    </div>
  </div>
</template>
